...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ChatAppUsingFirebase.SignIn, ChatAppUsingFirebase", SignIn.class, __md_methods);
	}
	...
	public SignIn ()
	{
		...
		if (getClass () == SignIn.class)
			mono.android.TypeManager.Activate ("ChatAppUsingFirebase.SignIn, ChatAppUsingFirebase", "", this, new java.lang.Object[] {  });
	}
